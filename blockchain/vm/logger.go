...
// transaction state before StateTransition mutates balances, nonces, or access
// lists. It is optional so existing tracers do not need to implement it.
type TxPrestateTracer interface {
	CaptureTxPreStart(env *EVM, from common.Address, feePayer common.Address, to common.Address, create bool, input []byte, value *big.Int)
}
